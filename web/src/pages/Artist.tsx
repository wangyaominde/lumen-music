...
export function ArtistPage() {
  ...
  return (
    <div className="px-4 sm:px-6 md:px-10 py-6 md:py-10">
      ...
      >
        <div
          className="w-20 h-20 md:w-32 md:h-32 rounded-full grid place-items-center text-[32px] md:text-[48px] font-semibold shrink-0"
        ...
        <div className="min-w-0">
          ...
          <h1 className="text-[26px] md:text-[40px] font-semibold leading-tight truncate">{data.artist.name}</h1>
      ...
      <div className="mb-4 text-lg md:text-xl font-semibold">专辑</div>
